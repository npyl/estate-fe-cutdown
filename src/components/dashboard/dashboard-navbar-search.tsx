...
const propertiesResults: any = {
  content: [],
};
const customersResults: any = {
  content: [],
};
...
export const DashboardNavbarSearch: FC = () => {
  ...
  const properties = useMemo(
    () =>
      searchCategory !== "customers" ? propertiesResults?.content || [] : [],
        ...
        endAdornment={
          ...
          >
            ...
            >
              ...
              <MenuItem value="properties">{t("Properties")}</MenuItem>
